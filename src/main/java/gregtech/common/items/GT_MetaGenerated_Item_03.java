...
public class GT_MetaGenerated_Item_03 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_03() {
        ...
        /*
         *Oredict tags for Wafers and chips
         */
        ...
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.Wafer,
            Materials.PhotonicallyDoped,
            ItemList.Circuit_Silicon_Wafer6.get(1L),
            true);
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.Wafer,
            Materials.PhotonicallyEnriched,
        ...
        GT_OreDictUnificator.addAssociation(
         ...
         GT_OreDictUnificator.addAssociation(
            OrePrefixes.CircuitChip,
            Materials.RAM,
            ItemList.Circuit_Chip_Ram.get(1L),
            true);
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.CircuitChip,
            Materials.NAND,
            ItemList.Circuit_Chip_NAND.get(1L),
            true);
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.CircuitChip,
            Materials.NOR,
            ItemList.Circuit_Chip_NOR.get(1L),
            true);
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.CircuitChip,
            Materials.CPU,
        ...
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.CircuitChip,
            Materials.QPIC,
            ItemList.Circuit_Chip_QPIC.get(1L),
            true);
        GT_OreDictUnificator.addAssociation(
            OrePrefixes.CircuitChip,
            Materials.Bioware,
            ItemList.Circuit_Chip_Bioware.get(1L),
            true);
        /*
